...
import { kv } from "@workspace/db/schema";

const memoryStore = new Map<string, string>();

async function readFromDatabase(key: string): Promise<string | null> {
...
async function writeToDatabase(key: string, value: string): Promise<boolean> {
