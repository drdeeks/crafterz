...
export async function writeJson<T>(key: string, value: T): Promise<void> {
  ...
  // Database unavailable — store in memory as fallback
  // If database becomes available later, this entry will NOT be auto-synced.
  // For critical data, ensure DATABASE_URL is configured.
