      ...
      <div className="mt-4">
        ...
        <div className="space-y-1.5">
          {recentDiscoveries.map((discovery, index) => (
            <div key={`${discovery.discoverer}-${discovery.name}-${discovery.time}-${index}`} className="flex items-center gap-3 bg-zinc-900 border border-zinc-800 rounded-xl px-3 py-2.5">
              <img
